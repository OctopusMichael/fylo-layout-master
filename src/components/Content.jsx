  ...
  return (
    <>
      <picture>
        ...
        <source media-="min-widht:  769px" srcSet={bgDesktop} />
        <img className="w-full" src={bgMobile} alt="Bgcontent" />
      </picture>
      <section className="bg-[#F8F8FE]  md:mt-[0]">
        <div className="mt-[0px] md:mt-[0px] h-auto text-center  px-[40px] md:px-[80px]  flex flex-col xl:flex-row py-[160px] md:pt-[0px] max-w-[1440px] mx-auto  ">
          <div className="md:order-2  md:p-[20px]">
            <img
              className="mb-[100px] md:mb-[0px] md:w-[800px]  md:ms-[30px] md:mt-[20px]"
              src={ilustration}
              alt="ilustration"
            />
          </div>
          <div className=" ">
            <h1 className="font-bold md:text-[40px]   text-center lg:text-start  ">
